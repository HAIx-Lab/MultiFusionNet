...
For instance, sub-database (Chowdhury et al. 2020) have six
...
(SIRM)COVID-19 Databse: The SIRMCOVID-19 database
(I S.I.S.O.M.A. 2020) includes 384 radiographic images
(CXR and CT) with varying resolution, comprising 94 chest
X-ray images and 290 lung CT images. Here, author took
CXR images only.
...
them with theGitHub database to prevent duplication.
They successfully acquired 60 COVID-19 positive chest Xray
images from 43 new articles and 32 positive chest X-ray
...
database are normal chest X-ray images without lung infections
...
sub-datasets exclusively contains CXR images, showcasing
